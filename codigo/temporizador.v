...
begin
    if(!rst_n) begin
        ...
        if (counter_1sec == ONE_SECOND) begin
            ...
            if (seconds_cnt == 6'd59) begin // incrementa el contador de segundos
                seconds_cnt <= 0;

                if (minutes_cnt == 6'd59) begin // incremena el contador de minutos
                    minutes_cnt <= 0;

                    if (hours_cnt == 7'd99) begin // incrementa el contador de horas (hasta 99 horas)
                        hours_cnt <= 0;
                    end else begin
